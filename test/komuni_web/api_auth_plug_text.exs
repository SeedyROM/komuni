defmodule KomuniWeb.APIAuthPlugTest do
  use KomuniWeb.ConnCase
  doctest KomuniWeb.APIAuthPlug

  alias KomuniWeb.{APIAuthPlug, Endpoint}
  alias MyApp.{Repo, Users.User}

  @pow_config [otp_app: :komuni]
